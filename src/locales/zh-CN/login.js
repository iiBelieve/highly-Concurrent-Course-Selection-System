export default {
  ...
  'app.login.tab-login-root': '管理员登录',
  'app.login.root': '管理员账号',
  'app.login.rootPassword': '密　　码',
  'app.login.message-invalid-credentials-root': '管理员账号或密码错误',
  'validation.root.required': '请输入管理员账号!',
  'validation.rootPassword.required': '请输入密码！',
